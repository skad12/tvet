...
// import { format } from "date-fns"; // optional; you can remove if date-fns not installed

// export default function ChatModal({ ticket, open, onClose, onOpenUser }) {
...
//           className="relative w-full max-w-4xl h-[80vh] bg-white rounded-lg shadow-xl flex"
//         >
//           {/* Left: conversation */}
...
//                 >
//                   {ticket?.email?.slice(0, 2).toUpperCase()}
//                 </button>
//                 <div>
...
//               <input
//                 className="flex-1 border rounded-full px-4 py-2 outline-none focus:ring-2 focus:ring-blue-200"
