...
//       layout
//       data-chat-box
//       className="lg:col-span-1 bg-white rounded-lg shadow-sm p-4 md:p-6 flex flex-col h-full md:min-h-[600px]"
//     >
//       <div className="mb-3">
//         <h3 className="font-medium text-slate-800">Conversation</h3>
//         <p className="text-xs text-slate-500">Selected ticket chat & replies</p>
...
//           {/* messages container: flex-1 so it scrolls, no fixed heights */}
//           <div
//             ref={containerRef}
...
//           {/* input area: prevent shrinking so it's always visible */}
//           <form
//             onSubmit={sendMessage}
//             className="flex gap-2 items-end mt-2 pt-2 border-t border-slate-200 flex-shrink-0"
//           >
//             <div className="flex-1">
//               <textarea
//                 className="w-full border border-slate-300 px-3 py-2 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      {!selected ? (
        ...
        <>
          ...
          <form
            onSubmit={sendMessage}
            className="flex gap-2 items-end mt-2 pt-2 border-t border-slate-200 flex-shrink-0"
            /* keep a little safe-area padding for devices with home indicator */
